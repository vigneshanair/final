...
CSV_OUTPUT = (
    "results/conflictguard_unseen_results.csv"
)

METRICS_OUTPUT = (
    "results/conflictguard_unseen_metrics.json"
)
...
def run():
    ...
    print(
        "CONFLICTGUARD UNSEEN EVALUATION"
    )
    ...
    print(
        "Verification Rate:",
        f"{metrics['verification_rate'] * 100:.2f}%"
    )
